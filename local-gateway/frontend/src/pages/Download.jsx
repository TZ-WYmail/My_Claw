  ...
  return (
    <div className="page-shell atlas-page-shell">
      ...
      <MailControlGrid
        ...
        accountTestResult={accountTestResult}
        accountTesting={accountTesting}
        accounts={accounts}
        handleAccountTest={handleAccountTest}
        handlePollingConfigChange={handlePollingConfigChange}
        loading={loading}
        pollingFeedback={pollingFeedback}
        pollingResults={pollingResults}
        pollingSaving={pollingSaving}
